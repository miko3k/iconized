 ...
 * this behaviour.
 * <p>
 * It understands high level ICO structure, decoding of individual images is delegated to {@link ImageDecoder}.
 * <p>
 * Assuming the underlying {@link ImageDecoder} is thread safe, this class is thread safe too.
 * </p>
 *
 * @param <T> The type of image produced
 *
 */
public class IconParser<T>  {
    private final ImageDecoder<T> imageDecoder;

    public IconParser(ImageDecoder<T> imageDecoder) {
     ...
     */
    public IconReader<T> openReader(InputStream stream) {
        return new IconReader<>(imageDecoder, stream);
    }
     ...
     * @return an instance of the icon reader
     */
    public IconReader<T> openReader(byte[] data) {
     ...
     */
    public List<T> getIcons(byte [] data) throws IOException {
     ...
     * @throws IOException when IO error occurs
     */
    public List<T> getIcons(byte [] data, IconErrorListener errorListener) throws IOException {
     ...
     * @throws IOException when IO error occurs
     */
    public List<T> getIcons(InputStream inputStream) throws IOException {
     ...
     * @throws IOException when IO error occurs
     */
    public List<T> getIcons(InputStream inputStream, IconErrorListener errorListener) throws IOException {
